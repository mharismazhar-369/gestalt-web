      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Elite financial expertise meets enterprise-grade workflow automation.
          </p>
        </div>
          ...
          >
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground">Chief Financial Officer</h3>
                  <p className="text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase tracking-wider">Co-Founder</p>
                </div>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
