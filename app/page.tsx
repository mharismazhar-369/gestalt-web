...
export default function HomePage() {
  return (
    <>
      ...
      <footer className="border-t border-border py-10 bg-background flex flex-col items-center transition-colors duration-500">
        
        {/* Social Media Links */}
        <div className="flex items-center gap-6 mb-6">
          
          {/* Twitter / X */}
          <a href="https://x.com/mharismaz" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Twitter">
          ...
          {/* TikTok */}
          <a href="https://www.tiktok.com/@mharismaz84?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="TikTok">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Vercel */}
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Vercel">
